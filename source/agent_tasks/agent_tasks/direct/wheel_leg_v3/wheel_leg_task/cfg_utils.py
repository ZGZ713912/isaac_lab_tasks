...
# WheelLegV3FlatEnvCfg 在 32 维基础特权观测之上再拼 39 维 privileged_extra
...
V14_ORDERED_LEG_JOINT_NAMES: tuple[str, ...] = (  # Wheel_leg_V3：4 个驱动腿电机关节（轮由 _wheel_idx 单独处理）
    "L_joint1",
    "LL_joint1",
    "R_joint1",
    "RR_joint1",
...
V14_ORDERED_LEG_BODY_NAMES: tuple[str, ...] = (  # Wheel_leg_V3：对应 4 根腿杆（髋/膝四杆主动杆）
    "L_link1",
    "LL_link1",
    "R_link1",
    "RR_link1",
...
V14_ROUGH_NP3O_BARLOW_PLUS_PRIV_REWARDS = OrderedDict(
    ...
    # - Only used by WheelLegV3RoughNP3OBarlowPlusPrivEnvCfg.
